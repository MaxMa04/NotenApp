    ...
    public class FachHinzufuegenViewModel
    {
        ...
        public FachHinzufuegenViewModel()
        {
            Faecher = new ObservableRangeCollection<HjFach>
            {
                ...
                new HjFach { Name = "Englisch"   , MinHalbjahre=4, Aufgabenfeld=(int)FachAufgabenfeld.Sprachlich           , IsLK=false, IsPrFach=false, IsFremdsprache=true     },
                ...
                new HjFach { Name = "Philosophie", MinHalbjahre=1, Aufgabenfeld=(int)FachAufgabenfeld.Kein                 , IsLK=false, IsPrFach=false, IsFremdsprache=false     },
